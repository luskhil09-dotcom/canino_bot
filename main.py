...
# ФОТО для статических меню (используем стандартные emoji как fallback)
PHOTOS = {
    "welcome": "https://i.imgur.com/YOUR_WELCOME_IMAGE.jpg",  # Замените на свою ссылку
    "balance": "https://i.imgur.com/YOUR_BALANCE_IMAGE.jpg",  # Замените на свою ссылку
    "stats": "https://i.imgur.com/YOUR_STATS_IMAGE.jpg",
    "help": "https://i.imgur.com/YOUR_HELP_IMAGE.jpg"
}
...
# Обработчик кнопок (упрощенная версия)
...
💳 Кредиты: `{user_data['credits']}`
🎯 Текущая ставка: `{user_data.get('current_bet', BASE_BET)}`

*Удачи в игре!* 🍀
            """,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🎰 Играть", callback_data="play_slots")],
                [InlineKeyboardButton("⚙️ Изменить ставку", callback_data="change_bet")],
                [InlineKeyboardButton("↩️ Назад", callback_data="back_to_menu")]
            ]),
            parse_mode='Markdown'
